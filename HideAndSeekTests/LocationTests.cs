...
namespace HideAndSeekTests
{
    ...
    public class LocationTests
    {
        ...
        /// <summary>
        /// Initializes each unit test by setting and creating a new centre location and adding a room in each direction before the test
        /// </summary>
        [TestInitialize]
        ...
        /// <summary>
        /// Ensure GetExit returns the location in a direction only if it exists
        /// </summary>
        [TestMethod]
